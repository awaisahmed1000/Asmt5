...
function positiveNumbersCount(numbersArray) {
...
function arrayLettersStartingWithA(wordsArray) {
    let newArray = [];
...
function getSquaredNumbersArray(numbersArray) {
    let squaredArray = [];
    for (let i = 0; i < numbersArray.length; i++) {
...
function findSmallestNumber(givenArray) {
...
function filterByLength(arrayOfStrings, n) {
    let newArray = [];
...
function characterFrequencyInString(stringValue, characterValue) {
